    ...
    <footer className="bg-background-900">
      <div className="relative mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="absolute end-4 top-4 sm:end-6 sm:top-6 lg:end-8 lg:top-8">
          <a
            className="inline-block rounded-full bg-secondary-500 p-2 text-white-100 shadow transition hover:bg-secondary-600 sm:p-3 lg:p-4"
            href="#MainContent"
          >
        ...
        <p className="mx-auto mt-6 max-w-md text-center leading-relaxed text-white-900">
          Immerse yourself in a realm where passion meets obsession as our
